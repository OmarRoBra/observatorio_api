...
router.post('/', news_controller_1.uploadMiddleware, news_controller_1.createNews);
router.get('/', news_controller_1.getAllNews);
router.get('/:id', news_controller_1.getNewsById);
router.put('/:id', news_controller_1.uploadMiddleware, news_controller_1.updateNews);
